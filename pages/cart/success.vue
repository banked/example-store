<template>
  <div>
    <masthead />
    <div class="alert-container bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md success-message" role="alert">
      <div class="flex">
        <div class="py-1">
        ...
        <div>
          ...
          <p class="text-sm">
            As this is a demo site, nothing will happen from here
          </p>
        </div>
      </div>
    </div>
